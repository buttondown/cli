...
describe("automations", () => {
  ...
  describe("deserialize", () => {
    it("should deserialize valid JSON", () => {
      ...
      expect(result.automation.actions).toEqual(SAMPLE_AUTOMATION.actions);
    });
  ...
  describe("REMOTE_AUTOMATIONS_RESOURCE", () => {
    it("should have serialize as identity function", () => {
      ...
      expect(REMOTE_AUTOMATIONS_RESOURCE.serialize(automations)).toEqual(
        automations,
      );
    });
    ...
    it("should have deserialize as identity function", () => {
      const automations = [SAMPLE_AUTOMATION as any];
      expect(REMOTE_AUTOMATIONS_RESOURCE.deserialize(automations)).toEqual(
        automations,
      );
    });
  });
  ...
  describe("LOCAL_AUTOMATIONS_RESOURCE", () => {
    it("should serialize automations to JSON strings", () => {
      const automations = [SAMPLE_AUTOMATION as any];
      const result = LOCAL_AUTOMATIONS_RESOURCE.serialize(automations);
    ...
    it("should deserialize JSON strings to automations", () => {
      ...
      const result = LOCAL_AUTOMATIONS_RESOURCE.deserialize(strings);
