...
export interface components {
  schemas: {
     ...
     * @enum {string}
     */
    FirewallReasonCode: "email_address_capital_letters" | "email_address_contains_prohibited_string" | "email_address_domain_burst" | "email_address_domain_reputation" | "email_address_extant_subscriber_count" | "email_address_gmail_word_numbers" | "email_address_has_gravatar" | "email_address_local_part_has_many_periods" | "email_address_malformed" | "email_address_many_consonants_in_a_row" | "email_address_mx_record_is_valid" | "email_address_noreply_local_part" | "email_address_plus_single_number" | "email_address_plus_variant_accounts" | "email_address_previous_evaluation" | "email_address_reputation" | "email_address_sandbox_test" | "email_address_shannon_entropy" | "email_address_tied_to_account" | "email_address_typo" | "embedded_form_honeypot" | "fingerprint_missing" | "ip_address_country_risk" | "ip_address_datacenter" | "ip_address_extant_subscriber_count" | "ip_address_peaceful" | "ip_address_previous_evaluation" | "ip_address_prohibited" | "newsletter_age" | "newsletter_has_customized_transactional_email" | "newsletter_has_prohibited_string" | "newsletter_status" | "project_honeypot" | "registration_without_prior_page_visit" | "subscriber_import_provenance" | "subscriber_import_source" | "text_contains_malicious_url" | "text_contains_prohibited_string" | "turnstile_response_token_is_valid" | "user_agent_known" | "username_shannon_entropy";
    /**
     * StripeCoupon 
     ...
     * @enum {string}
     */
    AutomationActionType: "add_tags" | "remove_tags" | "send_email" | "add_metadata" | "remove_metadata" | "change_email_address" | "gift_premium_subscription" | "ungift_premium_subscription" | "send_discord_invitation" | "send_github_invitation" | "create_subscriber" | "unsubscribe_subscriber" | "shopify_unsubscribe" | "shopify_resubscribe" | "shopify_set_tags" | "shopify_create_customer" | "send_notification" | "forward_reply" | "create_arena_post" | "create_bluesky_post" | "create_linkedin_post" | "create_mastodon_post" | "create_tumblr_post" | "create_twitter_post" | "create_export" | "create_gift_subscriber" | "send_post_request" | "send_confirmation_reminder" | "update_email_type";
    /**
  ...
  create_subscriber: {
    parameters: {
      header: {
         ...
         * - "add", which will merge the new subscriber data into the existing one. For unsubscribed subscribers, this resubscribes them as regular when type is omitted, or as unactivated and sends a new confirmation email when type is "unactivated".
         */
